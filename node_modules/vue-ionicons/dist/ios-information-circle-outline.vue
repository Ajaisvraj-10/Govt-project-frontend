...
export default {
  ...
  data () {
    let iconTitle = this.title ? this.title : "Ios Information Circle Outline Icon"
    return {
      iconTitle: iconTitle
    }
  }
