...
export default {
  ...
  data () {
    let iconTitle = this.title ? this.title : "Ios Close Circle Outline Icon"
    return {
      iconTitle: iconTitle
    }
  }
