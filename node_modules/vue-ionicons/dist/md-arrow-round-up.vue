...
export default {
  ...
  data () {
    let iconTitle = this.title ? this.title : "Md Arrow Round Up Icon"
    return {
      iconTitle: iconTitle
    }
  }
