...
export default {
  ...
  data () {
    let iconTitle = this.title ? this.title : "Ios Arrow Dropleft Icon"
    return {
      iconTitle: iconTitle
    }
  }
