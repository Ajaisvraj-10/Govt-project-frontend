...
export default {
  ...
  data () {
    let iconTitle = this.title ? this.title : "Ios Musical Notes Icon"
    return {
      iconTitle: iconTitle
    }
  }
