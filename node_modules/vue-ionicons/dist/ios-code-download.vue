...
export default {
  ...
  data () {
    let iconTitle = this.title ? this.title : "Ios Code Download Icon"
    return {
      iconTitle: iconTitle
    }
  }
