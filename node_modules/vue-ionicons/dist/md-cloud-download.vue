...
export default {
  ...
  data () {
    let iconTitle = this.title ? this.title : "Md Cloud Download Icon"
    return {
      iconTitle: iconTitle
    }
  }
