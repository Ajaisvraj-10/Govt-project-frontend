...
export default {
  ...
  data () {
    let iconTitle = this.title ? this.title : "Md Git Pull Request Icon"
    return {
      iconTitle: iconTitle
    }
  }
