...
export default {
  ...
  data () {
    let iconTitle = this.title ? this.title : "Ios Cloud Outline Icon"
    return {
      iconTitle: iconTitle
    }
  }
