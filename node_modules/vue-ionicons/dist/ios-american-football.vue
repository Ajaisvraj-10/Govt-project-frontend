...
export default {
  ...
  data () {
    let iconTitle = this.title ? this.title : "Ios American Football Icon"
    return {
      iconTitle: iconTitle
    }
  }
