...
export default {
  ...
  data () {
    let iconTitle = this.title ? this.title : "Ios Reverse Camera Icon"
    return {
      iconTitle: iconTitle
    }
  }
