...
export default {
  ...
  data () {
    let iconTitle = this.title ? this.title : "Ios Arrow Dropdown Icon"
    return {
      iconTitle: iconTitle
    }
  }
