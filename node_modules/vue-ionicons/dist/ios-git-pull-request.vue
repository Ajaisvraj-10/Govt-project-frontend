...
export default {
  ...
  data () {
    let iconTitle = this.title ? this.title : "Ios Git Pull Request Icon"
    return {
      iconTitle: iconTitle
    }
  }
